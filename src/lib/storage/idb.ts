...
export async function setSpaces(userId: string, spaces: Space[]): Promise<void> {
...
export async function setGroups(userId: string, groups: Group[]): Promise<void> {
...
export async function setBookmarks(userId: string, bookmarks: Bookmark[]): Promise<void> {
