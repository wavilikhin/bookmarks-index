 ...
 */
export function AddEditModal({ isOpen, onClose, entityType, mode, entity, onSubmit }: AddEditModalProps) {
        ...
        >
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-end gap-2 border-t border-border/50 px-5 py-4">
              <DialogPrimitive.Close render={<Button type="button" variant="outline" />}>Cancel</DialogPrimitive.Close>
