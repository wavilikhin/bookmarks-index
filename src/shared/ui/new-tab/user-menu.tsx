 ...
 */
export const UserMenu = reatomComponent(({ user, onSettings, theme, onThemeChange }: UserMenuProps) => {
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" sideOffset={8} className="w-56">
        ...
        <div className="flex items-center gap-3 px-2 py-2.5">
          {user.avatarUrl ? (
            ...
            <div className={cn('flex size-9 items-center justify-center rounded-full', 'bg-primary/10 text-primary')}>
